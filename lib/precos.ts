...
export const serviceLines: ServiceLine[] = [
  ...
  },
  {
    ...
    name: "Cloud / GCP",
    tagline:
      "Cache, performance e processamento pesado que o Zoho não alcança — sobre o Google Cloud.",
    tiers: [
      {
        name: "Camada de Performance",
        from: 10000,
        scope: "Cache, filas e workers para acelerar o que hoje trava no Zoho ou em planilhas.",
        timeline: "3–6 semanas",
        deliverables: [
          "Cache em Memorystore (Redis) na frente do Zoho e de APIs",
          "Workers e filas em Cloud Run para tarefas assíncronas",
          "Rate limiting e resiliência (retry, backoff)",
          "Observabilidade e otimização de custo",
        ],
      },
      {
        name: "Processamento Pesado",
        from: 25000,
        destaque: true,
        scope: "Computação e dados em volume que o Zoho/Deluge não suporta.",
        timeline: "4–8 semanas",
        deliverables: [
          "Jobs de processamento intensivo em Cloud Run / GKE",
          "Pipelines de dados e ETL para BigQuery",
          "Cálculos e relatórios que estouram os limites do Zoho",
          "CI/CD via Cloud Build + infraestrutura como código",
        ],
      },
      {
        name: "Arquitetura Híbrida Cloud + Zoho",
        from: 55000,
        scope: "Scale-up: GCP como motor de performance integrado ao ecossistema Zoho.",
        timeline: "12–16 semanas",
        deliverables: [
          "Arquitetura híbrida GCP ↔ Zoho desenhada e implementada",
          "Camada de cache + processamento + analytics",
          "Governança, segurança e infraestrutura como código",
          "Plano de custo e continuidade · 90 dias de hypercare",
        ],
      },
    ],
  },
